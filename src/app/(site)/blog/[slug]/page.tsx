				...
				<section className="px-6 max-sm:pt-10 md:py-20 bg-white pb-0 md:pb-0">
					<div className="grid grid-cols-1 justify-items-center homeAdjust">
						...
						<div className="max-full text-center leading-relaxed mb-8">
							<p className="font-semibold tracking-tighter mt-8 mb-8">
								By: <a href="#">{post.data.author}</a> |
								Category:{' '}
								<span className="relative z-10 rounded-full bg-red-600 px-3 py-1.5 font-medium text-white hover:bg-red-400 cursor-pointer">
									{category}
								</span>{' '}
								| Posted:{' '}
								<Date dateString={post.data.postdate} />
							</p>
					...
					<div className="py-8 flex flex-col">
						<div className="mx-auto w-full max-w-3xl">
							<Markdown
								className={`flex-col article_text max-w-5xl mx-auto`}
							>
								{post.content}
							</Markdown>
						...
						<div className="bg-slate-50 max-sm:pt-12 px sm:rounded-6xl">
							<div className="relative mx-auto -mt-16 h-44 w-44 overflow-hidden rounded-full bg-slate-200 md:float-right md:h-64 md:w-64 md:[shape-outside:circle(40%)] lg:mr-20 lg:h-72 lg:w-72">
								<img
									...
									decoding="async"
									data-nimg="1"
									className="absolute inset-0 h-full w-full object-top object-cover shadow-xl"
									loading="lazy"
							...
							<div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32 rounded shadow-xl">
								...
								<p className="mt-2 font-display font-extrabold tracking-tight text-slate-900 sm:text-2xl">
									Co-Founder, busy
									<span style={{ color: 'red' }}>little</span>
									pixels.
								</p>
								<p className="mt-4 text-md tracking-tight text-slate-700 article_text">
									I’ve been designing and developing
									professionally for over a decade and have
									worked with dozens of the biggest brands to
									create roadmaps to success for their
									products and tech. I’ve worked with
									companies from startups to Nasdaq listed
									enterprises, and honed my abilities to
									navigate the brave new world that is all
									things tech.
								</p>
							</div>
						</div>
