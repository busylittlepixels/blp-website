						...
						<div className="grid grid-cols-1 justify-items-center gap-2 md:gap-10 homeAdjust mb-2">
							<div className="max-full text-left leading-relaxed">
								<h1 className="font-black text-4xl md:text-7xl mb-6 last:mb-0 text-center">
									Welcome to our <br /> BUSY
									<span style={{ color: 'red' }}>LITTLE</span>STUDIO
								</h1>
					...
					<div className="bg-white py-12 sm:py-12 lg:py-20">
						<div className="mx-auto max-w-screen-2xl px-4 md:px-8">
							...
							<div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
								...
								>
									<img
										src="/assets/images/websummit.png"
										loading="lazy"
								...
								<a
									href="https://nutriband.com"
									target="_blank"
									rel="noopener noreferrer"
									className="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:col-span-2 md:h-80"
								>
									<img
										src="/assets/images/nutriband.png"
										loading="lazy"
								...
								<a
									href="https://runrepublic.com/"
									target="_blank"
									rel="noopener noreferrer"
									className="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-80"
								>
									<img
										src="/assets/images/runrepublic.png"
										loading="lazy"
								...
								<a
									href="https://izabelvaz.com"
									target="_blank"
									rel="noopener noreferrer"
									className="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-80"
								>
									<img
										src="/assets/images/isabel.png"
										loading="lazy"
								...
								>
									<img
										src="/assets/images/tnw-conference.png"
										loading="lazy"
										alt="TNW Conference"
										className="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110"
									/>
								...
								>
									<img
										src="/assets/images/ro-couch-desk.jpeg"
										loading="lazy"
										alt="Danger Ro"
										className="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110"
									/>
								...
								<a
									href="https://algarvemusicseries.com"
									target="_blank"
									rel="noopener noreferrer"
									className="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:col-span-2 md:h-80"
								>
