						...
						<div className="mx-auto max-w-7xl px-6 lg:px-8">
							<div className="mx-auto max-w-2xl lg:mx-0">
								...
								<p className="mt-6 text-lg leading-8 text-gray-300">
									We{`'`}re always happy to hear from you. Feel free to contact us via the form or
									our social platforms. For general enquires, see contact email below. For feedback,
									comments, questions or the odd SOS...please use the form on this page. We will
							...
							<div className="mx-auto max-w-2xl lg:mx-0">
								<dl className="mt-10 space-y-4 text-base leading-7 text-gray-300">
									...
									<div className="flex gap-x-4">
										...
										<dd>
											<a className="hover:text-gray-900" href="mailto:team@busylittlepixels.com">
							...
							<div className="lg:w-1/3 md:w-2/3 bg-white rounded-lg p-8 flex flex-col md:ml-auto  mt-10 md:mt-0 relative z-10 shadow-md">
								<>
									...
									<p className="leading-relaxed mt-5 text-black">
										Please complete the form below. We aim to reply to all messages within 24 hours.
									</p>
									<br />
									<HubSpotForm />
								</>
