			...
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto max-w-2xl lg:mx-0">
					...
					<p className="mt-6 text-lg leading-8 text-gray-300">
						We are a dynamic and distributed fractional CTO company founded by a team of
						experienced professionals who have walked the path of CTOs, Technical Leads,
						Developers, and Marketing Specialists. <br />
						<br />
						With our studios headquartered in the bustling tech hub of Dublin, and
						distributed bases in Austria, the UK and The Netherlands - we bring together
						a wealth of expertise and a passion for driving technological innovation.
					</p>
				</div>
				<ul
					role="list"
