                ...
                <div className="slider-wrapper">
                    <div className="slider-container"> 
                        <div className="control-nav">
                            <ul>
                                <li className="active"><span className="line"></span><span className="number">1</span></li>
                                <li><span className="line"></span><span className="number">2</span></li>
                                <li><span className="line"></span><span className="number">3</span></li>
                                <li><span className="line"></span><span className="number">4</span></li>
                            </ul>
                        </div>
                        ...
                        <div className="image-mask">
                            <img className="" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/42764/karlie-kloss_copy.png" alt="" />
                        </div>
                        <div className="slide active red" data-order="1" data-color="#EE4654" data-img="https://s3-us-west-2.amazonaws.com/s.cdpn.io/42764/karlie-kloss_copy.png">
                        ...
                        <div className="slide blue" data-order="2" data-color="#EE4654" data-img="https://s3-us-west-2.amazonaws.com/s.cdpn.io/42764/aline-weber.png">
